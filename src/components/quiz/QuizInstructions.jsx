    ...
    <div className="instructions container">
      ...
      <ul className="browser-default" id="main-list">
        ...
        <li>
          ...
          <span className='span.mdi mdi-set-center mdi-24px lifeline-icon'></span>
        ...
        <li>
          ...
          <span className='span.mdi mdi-lightbulb-on mdi-24px lifeline-icon'></span>
          will remove one wrong answer leaving two wrong answers and one correc answer. You can use as many hints as possible on a single question.
